...
<div class="d-md-flex flex-md-equal">
        <div style="padding-left:7%; padding-top:3%;" class="col-md-6 mt-3">
          ...
          <p style="padding-left:5%" class="lead"><i class="fas fa-paw" style="color: peru;"></i> If you already have an account click on <a href="/auth/login"><span style="color:peru"><b>Login</b></span></a></p>
          <p style="padding-left:10%" class="lead"><i class="fas fa-paw"></i> If you don't have an account already then click on <a href="/auth/register"><span style="color:peru"><b>Register</b></span></a></p>
